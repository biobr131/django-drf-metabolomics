...
CREATE SEQUENCE public.django_migrations_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.silk_profile_id_seq;
...
CREATE SEQUENCE public.silk_profile_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.silk_profile_queries_id_seq;
...
CREATE SEQUENCE public.silk_profile_queries_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.silk_sqlquery_id_seq;
...
CREATE SEQUENCE public.silk_sqlquery_id_seq
	...
	START 1
	CACHE 1
	NO CYCLE;-- public.accounts_customuser definition
...
-- public.silk_request definition
...
CREATE TABLE public.django_admin_log (
	...
	CONSTRAINT django_admin_log_user_id_c564eba6_fk_accounts_customuser_id FOREIGN KEY (user_id) REFERENCES public.accounts_customuser(id) DEFERRABLE INITIALLY DEFERRED
);
CREATE INDEX django_admin_log_content_type_id_c4bce8eb ON public.django_admin_log USING btree (content_type_id);
CREATE INDEX django_admin_log_user_id_c564eba6 ON public.django_admin_log USING btree (user_id);


-- public.silk_profile definition
...
CREATE TABLE public.silk_profile (
	...
	CONSTRAINT silk_profile_request_id_7b81bd69_fk_silk_request_id FOREIGN KEY (request_id) REFERENCES public.silk_request(id) DEFERRABLE INITIALLY DEFERRED
);
...
-- public.silk_response definition
...
CREATE TABLE public.silk_response (
	...
	CONSTRAINT silk_response_request_id_1e8e2776_fk_silk_request_id FOREIGN KEY (request_id) REFERENCES public.silk_request(id) DEFERRABLE INITIALLY DEFERRED
);
...
-- public.silk_sqlquery definition
...
CREATE TABLE public.silk_sqlquery (
	...
	CONSTRAINT silk_sqlquery_request_id_6f8f0527_fk_silk_request_id FOREIGN KEY (request_id) REFERENCES public.silk_request(id) DEFERRABLE INITIALLY DEFERRED
);
...
-- public.silk_profile_queries definition
...
CREATE TABLE public.silk_profile_queries (
	...
	CONSTRAINT silk_profile_queries_profile_id_a3d76db8_fk_silk_profile_id FOREIGN KEY (profile_id) REFERENCES public.silk_profile(id) DEFERRABLE INITIALLY DEFERRED,
	CONSTRAINT silk_profile_queries_sqlquery_id_155df455_fk_silk_sqlquery_id FOREIGN KEY (sqlquery_id) REFERENCES public.silk_sqlquery(id) DEFERRABLE INITIALLY DEFERRED
);
